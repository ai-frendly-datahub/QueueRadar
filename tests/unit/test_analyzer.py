...
Article = cast(_ArticleCtor, import_module("queueradar.models").Article)
EntityDefinition = cast(_EntityCtor, import_module("queueradar.models").EntityDefinition)
apply_entity_rules = cast(_ApplyEntityRules, import_module("queueradar.analyzer").apply_entity_rules)
