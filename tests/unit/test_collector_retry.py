...
from queueradar.collector import RateLimiter, _collect_single, collect_sources
...
class TestCollectorRetryLogic:
    ...
    def test_retry_on_timeout(self) -> None:
        ...
        with patch("queueradar.collector.requests.get") as mock_get:
            mock_response = Mock()
...
<rss version="2.0">
    ...
    def test_session_reuse(self) -> None:
        ...
        with (
            patch("queueradar.collector.requests.Session.get") as mock_get,
